...
const ContactButton = styled.input`
  ...
  cursor: pointer;
  &:hover {
    background: hsla(200, 100%, 40%, 1);
    background: linear-gradient(225deg, hsla(200, 100%, 40%, 1) 0%, hsla(223, 100%, 40%, 1) 100%);
    background: -moz-linear-gradient(225deg, hsla(200, 100%, 40%, 1) 0%, hsla(223, 100%, 40%, 1) 100%);
    background: -webkit-linear-gradient(225deg, hsla(200, 100%, 40%, 1) 0%, hsla(223, 100%, 40%, 1) 100%);
  }
`
...
const Contacto = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    emailjs.sendForm('service_7zovf38', 'template_ehahghf', form.current, 'Vfpu87NZuhslY4eJl')
